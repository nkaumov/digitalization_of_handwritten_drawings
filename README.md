...
- Этап 9 в работе: реализована базовая предобработка изображений и debug-артефакты, не закрыт из-за отсутствия тестового набора сравнения.
...
- Тестовый набор и сравнение качества предобработки (этап 9).
